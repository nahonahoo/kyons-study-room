...
function renderSection2() {
  ...
  var items = [
    ...
    { yomi:'たずねる', q:'「駅までの道を〔　〕。」', choices:['尋ねる','訪ねる','尋ねる'], answer:'尋ねる', exp:'尋ねる＝質問する。訪ねる＝人の家などを訪問する。' },
    ...
    { yomi:'のぞむ', q:'「海に〔　〕ホテルに泊まる。」', choices:['臨む','望む','臨む'], answer:'臨む', exp:'臨む＝その場に面する、参加する。望む＝そうあってほしいと願う。' },
